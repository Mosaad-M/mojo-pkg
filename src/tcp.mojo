...
# SOL_SOCKET / SO_RCVTIMEO / SO_SNDTIMEO differ between Linux and macOS
...
def _resolve_host(host: String, port: Int) raises -> SockAddrIn:
    ...
    # Linux:  ai_addr at offset 24, ai_canonname at offset 32
    # macOS:  ai_canonname at offset 24, ai_addr at offset 32
